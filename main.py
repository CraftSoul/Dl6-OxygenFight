...
oxygen=12
history=[]
mapping={'抑制':'image/restrain.png',
'思考者':'image/thinker.png',
'手枪':'image/gun.png',
'金属探测器':'image/detector.png',
'气瓶':'image/bottle.png',
'勾玉':'image/jade.png',
'暴风吸入':'image/inhalation.png',
'小百合':'image/jenkins.png',
'导弹':'image/missile.png',
'葫芦湖水怪':'image/monster.png',
'律师徽章':'image/attorney.png',
'检察官徽章':'image/prosecutor.png',
'钓竿':'image/rod.png',
'大将军长枪':'image/spear.png',
'小刀':'image/knife.png',
'相机':'image/camera.png',
'复仇':'image/revenge.png',
'拉炮':'image/pull.png',
'仓院之壶':'image/pot.png',
'尸检报告':'image/autopsy.png',
'心灵枷锁':'image/lock.png',
'抉择':'image/chose.png',
'挣扎':'image/struggle.png'}

class app(App):
	def __init__(self):
		super(app,self).__init__()
		self.bg=Image(source='image/bg.png',allow_stretch=True,keep_ratio=True)
		...
		u.repeat=True
		u.start(self.home)
		self.t=Image(source='image/title.png',size_hint=(1,0.3),pos_hint={'y':0.6},allow_stretch=True,keep_ratio=True)
		...
		self.inroduction=[Button(background_normal=f'image/{x}.jpg') for x in range(4)]
...
class Card(RelativeLayout):
	def __init__(self,player,name,da=1,**kwargs):
		...
		with self.canvas:
			...
			self.add_widget(Image(source=mapping[name],size_hint=(0.9,0.52),pos_hint={'x':0.05,'y':0.45},allow_stretch=True,keep_ratio=False))
...
class Player:
	def __init__(self,name,is_player,x,take,index):
		...
		if is_player:
			...
			self.head=Image(source={'御剑信':'image/gregory.png','灰根高太郎':'image/yanni.png'}[name],size_hint=(0.1,0.2),pos_hint={'x':x,'y':0.6},allow_stretch=True,keep_ratio=True)
